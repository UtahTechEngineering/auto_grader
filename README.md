...
- `GH_PAT` - Generate a fine-grained Personal Access Token (PAT) following [these instructions](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens) and save it in this Github secret. Your token needs the following access:
